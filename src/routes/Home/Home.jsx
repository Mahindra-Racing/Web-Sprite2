            ...
            <div id="section2">
                ...
                <div className="main-container">
                    ...
                    <div className="side-content">
                        ...
                        <hr className="hr3" />
                        <a href="#" className="noticia">Noticiaaaaaaaaaaaaaaaaaaa</a>
                        <hr className="hr3" />
                        <a href="#" className="noticia">Noticia</a>
                        <hr className="hr3" />
                        <a href="#" className="noticia">Noticia</a>
                        <hr className="hr3" />
                        <a href="#" className="noticia">Noticia</a>
