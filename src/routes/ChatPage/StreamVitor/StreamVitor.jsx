                ...
                <div className="streaming-page">
                    ...
                    <div className="main-content">
                        <div className="streaming-box">
                            <img
                                src="https://www.webmotors.com.br/wp-content/uploads/2021/04/26124504/GPF3-1-1024x576-1.jpg"
                                alt="Live Streaming"
                                className="streaming-image"
                            />
                            <div className="streaming-info">
                                <img src="https://media-gru1-2.cdn.whatsapp.net/v/t61.24694-24/429559233_441751231759071_3747053932304203203_n.jpg?ccb=11-4&oh=01_Q5AaINBtI7mKS2PRLMSD3XVXTfKCOgzzXn0RXaYOwJQSIUii&oe=6730F873&_nc_sid=5e03e0&_nc_cat=105" alt="Streaming Info" className="info-image" />
                                <div className="streaming-info-text">
                                    <h2>Vitor Eskes</h2>
                                    <p>Junte-se a nós para uma transmissão ao vivo cheia de emoção e análises das corridas!</p>
                    ...
                    <div className="modal-overlay" onClick={handleModalClose}>
                        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="modal-header">
                                <img src='https://media-gru1-2.cdn.whatsapp.net/v/t61.24694-24/429559233_441751231759071_3747053932304203203_n.jpg?ccb=11-4&oh=01_Q5AaINBtI7mKS2PRLMSD3XVXTfKCOgzzXn0RXaYOwJQSIUii&oe=6730F873&_nc_sid=5e03e0&_nc_cat=105' alt="User Profile" className="modal-profile-image" />
                                <div>
                                    <h3>Vitor Eskes</h3>
                            ...
                            <div className="modal-body">
                                ...
                                <img src="https://www.brawlstarsdicas.com.br/wp-content/uploads/2023/09/spray-squeak-university-brawl-stars.png" alt="Gift Image" className="gift-image" />
