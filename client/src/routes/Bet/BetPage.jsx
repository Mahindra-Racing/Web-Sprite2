                    ...
                    <div className="content-containerBET">
                        ...
                        {pagina === 'wallet' && (
                            <div className="wallet-containerBET">
                                ...
                                <div className="saldo-valorBET saldo-grandeBET">R$ {saldo.toFixed(2)}</div>
                        ...
                        {pagina === 'bet' && (
                            <div className="bet-containerBET">
                                ...
                                <div className="saldo-valorBET saldo-pequenoBET">Saldo: R$ {saldo.toFixed(2)}</div>
                                    ...
                                    {apostas.length === 0 ? (
                                        ...
                                        apostas.map((aposta, index) => (
                                            <div key={index} className="aposta-itemBET">
                                                ...
                                                <span>R$ {aposta.valor.toFixed(2)}</span>
                                            </div>
                                        ))
                                    )}
                                </div>
